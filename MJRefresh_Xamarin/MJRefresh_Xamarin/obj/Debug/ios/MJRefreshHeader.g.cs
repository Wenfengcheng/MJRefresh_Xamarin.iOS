...
public unsafe partial class MJRefreshHeader : global::MJRefreshComponent {
	...
	[CompilerGenerated]
	public unsafe static global::MJRefreshHeader HeaderWithRefreshingBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMJRefreshComponentRefreshingBlock))]global::MJRefreshComponentRefreshingBlock refreshingBlock)
	{
		...
		ret =  Runtime.GetNSObject<global::MJRefreshHeader> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("headerWithRefreshingBlock:"), (IntPtr) block_ptr_refreshingBlock));
	...
	[CompilerGenerated]
	public static global::MJRefreshHeader HeaderWithRefreshingTarget (NSObject target, Selector action)
	{
		if (target == null)
			throw new ArgumentNullException ("target");
		if (action == null)
			throw new ArgumentNullException ("action");
		return  Runtime.GetNSObject<global::MJRefreshHeader> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("headerWithRefreshingTarget:refreshingAction:"), target.Handle, action.Handle));
	}
	
	[CompilerGenerated]
	public virtual nfloat IgnoredScrollViewContentInsetTop {
		[Export ("ignoredScrollViewContentInsetTop")]
		get {
			if (IsDirectBinding) {
				return global::ApiDefinition.Messaging.nfloat_objc_msgSend (this.Handle, Selector.GetHandle ("ignoredScrollViewContentInsetTop"));
			} else {
				return global::ApiDefinition.Messaging.nfloat_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("ignoredScrollViewContentInsetTop"));
			}
		}
		
		[Export ("setIgnoredScrollViewContentInsetTop:")]
		set {
			if (IsDirectBinding) {
				global::ApiDefinition.Messaging.void_objc_msgSend_nfloat (this.Handle, Selector.GetHandle ("setIgnoredScrollViewContentInsetTop:"), value);
			} else {
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_nfloat (this.SuperHandle, Selector.GetHandle ("setIgnoredScrollViewContentInsetTop:"), value);
			}
		}
	}
	...
	public partial class MJRefreshHeaderAppearance : global::MJRefreshComponent.MJRefreshComponentAppearance {
