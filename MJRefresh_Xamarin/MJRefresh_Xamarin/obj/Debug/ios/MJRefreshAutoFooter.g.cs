...
public unsafe partial class MJRefreshAutoFooter : global::MJRefreshFooter {
	...
	public virtual nfloat AppearencePercentTriggerAutoRefresh {
		...
		[Introduced (PlatformName.iOS, 2,0, message: "请使用triggerAutomaticallyRefreshPercent属性")]
		[Deprecated (PlatformName.iOS, 2,0, message: "请使用triggerAutomaticallyRefreshPercent属性")]
		[Export ("setAppearencePercentTriggerAutoRefresh:")]
		set {
			if (IsDirectBinding) {
	...
	[CompilerGenerated]
	public virtual nfloat TriggerAutomaticallyRefreshPercent {
		[Export ("triggerAutomaticallyRefreshPercent")]
		get {
			if (IsDirectBinding) {
				return global::ApiDefinition.Messaging.nfloat_objc_msgSend (this.Handle, Selector.GetHandle ("triggerAutomaticallyRefreshPercent"));
			} else {
				return global::ApiDefinition.Messaging.nfloat_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("triggerAutomaticallyRefreshPercent"));
			}
		}
		
		[Export ("setTriggerAutomaticallyRefreshPercent:")]
		set {
			if (IsDirectBinding) {
				global::ApiDefinition.Messaging.void_objc_msgSend_nfloat (this.Handle, Selector.GetHandle ("setTriggerAutomaticallyRefreshPercent:"), value);
			} else {
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_nfloat (this.SuperHandle, Selector.GetHandle ("setTriggerAutomaticallyRefreshPercent:"), value);
			}
		}
	}
	
	public partial class MJRefreshAutoFooterAppearance : global::MJRefreshFooter.MJRefreshFooterAppearance {
